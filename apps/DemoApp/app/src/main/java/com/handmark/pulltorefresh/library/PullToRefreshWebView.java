...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	protected boolean isReadyForPullEnd() {
		float exactContentHeight = Utils.floor(mRefreshableView.getContentHeight() * mRefreshableView.getScale());
	...
	final class InternalWebViewSDK9 extends WebView {
		...
		private int getScrollRange() {
			return (int) Math.max(0, Utils.floor(mRefreshableView.getContentHeight() * mRefreshableView.getScale())
